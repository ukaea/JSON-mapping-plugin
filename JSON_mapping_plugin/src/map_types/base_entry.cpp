...
int ValueEntry::map(
    ...
    if (temp_val.is_array()) {
        ...
        bool all_number = std::all_of(temp_val.begin(), temp_val.end(),
...
int ValueEntry::type_deduc_array(DATA_BLOCK* data_block,
    ...
    switch (temp_val.front().type()) {
        case nlohmann::json::value_t::number_float: {
            ...
            imas_json_plugin::uda_helpers
            ::setReturnDataArrayType_Vec<float>(data_block, temp_vec);
            break;
        } case nlohmann::json::value_t::number_integer: {
            // Handle array of ints
            auto temp_vec = temp_val.get<std::vector<int>>();
            imas_json_plugin::uda_helpers
            ::setReturnDataArrayType_Vec<int>(data_block, temp_vec);
            break;
        } case nlohmann::json::value_t::number_unsigned: {
            // Handle array of ints
            auto temp_vec = temp_val.get<std::vector<unsigned int>>();
            imas_json_plugin::uda_helpers
            ::setReturnDataArrayType_Vec<unsigned int>(data_block, temp_vec);
            break;
        }
        default:
            return 1;
...
int ValueEntry::type_deduc_prim(DATA_BLOCK* data_block,
    ...
    switch (temp_val.type()) {
        ...
        case nlohmann::json::value_t::number_unsigned:
            // Handle int
            imas_json_plugin::uda_helpers
            ::setReturnDataScalarType<unsigned int>(
        ...
        case nlohmann::json::value_t::string: {
            ...
            try {
                ...
                imas_json_plugin::uda_helpers
                ::setReturnDataScalarType<int>(data_block, i_str, nullptr);
