...
*		future reference.	
*   read    Entry function for the signal read from the IMAS interface.
*
*---------------------------------------------------------------------------------------------------------------*/
...
int JSONMappingPlugin::init(IDAM_PLUGIN_INTERFACE* plugin_interface) {
    ...
    if (!init_
            || STR_IEQUALS(request_data->function, "init")
...
{
    const char* help = "\nJSONMappingPlugin: Add Functions Names, Syntax, and Descriptions\n\n";
 ...
 * @return
 */
int JSONMappingPlugin::build_date(IDAM_PLUGIN_INTERFACE* idam_plugin_interface)
{
 ...
 * @return
 */
int JSONMappingPlugin::default_method(IDAM_PLUGIN_INTERFACE* idam_plugin_interface)
{
 ...
 * @return
 */
int JSONMappingPlugin::max_interface_version(IDAM_PLUGIN_INTERFACE* idam_plugin_interface)
{
